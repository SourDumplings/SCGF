...
def main():
    ...
    key_conf_path = os.path.join(project_base_dir, 'conf/dist/Key.xml')
    ...
    input_directory = os.path.join(project_base_dir, "res/dist/scgf/script")
    output_directory = os.path.join(project_base_dir, "res/script")
