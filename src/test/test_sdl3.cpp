...
int test_ttf()
{
	...
	TTF_Font *font = TTF_OpenFont("res/dist/font/Jinglei.ttf", 48);
	...
	SDL_FRect shadedRect =
		{0, 50, static_cast<float>(shadedSurface->w), static_cast<float>(shadedSurface->h)};
	...
	SDL_FRect lcdRect =
		{0, 100, static_cast<float>(lcdSurface->w), static_cast<float>(lcdSurface->h)};
	...
	SDL_FRect blendedRect =
		{0, 150, static_cast<float>(blendedSurface->w), static_cast<float>(blendedSurface->h)};
...
int test_mixer()
{
	...
	Mix_Music *bgm = Mix_LoadMUS("res/dist/sound/WhenTheMorningComes.mp3");
	Mix_VolumeMusic(100);
	Mix_PlayMusic(bgm, -1);

	Mix_Chunk *sound1 = Mix_LoadWAV("res/dist/sound/Hit.mp3");
	Mix_Chunk *sound2 = Mix_LoadWAV("res/dist/sound/Failed.mp3");
...
void DrawFont(
	...
	TTF_Font *font,
	const scgf::util::UTF8String &text,
	int x,
	int y
)
{
...
int test_input()
{
	...
	scgf::util::UTF8String text;
	scgf::util::UTF8String editing;
