...
void test_set_log_level()
{
	std::cout << "Current log level: "
			  << scgf::util::Logger::get_instance().get_logic_logger_level() << std::endl;
	SCGF_LOG_TRACE("trace message1");
	SCGF_LOG_DEBUG("debug message1");
	scgf::util::Logger::get_instance().set_logic_logger_level(scgf::util::Logger::LogLevel::trace);
	std::cout << "Current log level: "
			  << scgf::util::Logger::get_instance().get_logic_logger_level() << std::endl;
	...
	scgf::util::Logger::get_instance().set_logic_logger_level(scgf::util::Logger::LogLevel::debug);
	std::cout << "Current log level: "
			  << scgf::util::Logger::get_instance().get_logic_logger_level() << std::endl;
