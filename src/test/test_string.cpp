...
int test_string()
{
	...
	scgf::util::UTF8String str(u8"你好，世界！Hello, World!啦啦啦");
	...
	scgf::util::UTF8String str1(u8"你好，世界！啦啦啦");
	scgf::util::UTF8String str2(u8"你好，世界！");
	scgf::util::UTF8String str3(u8"你好，世界！");
	scgf::util::UTF8String str4(u8"你好，lalala世界！");
	scgf::util::UTF8String str5(u8"你好，lalala世界！");
	scgf::util::UTF8String str6(u8"你好，lalahi世界！");
	printf("str1 == str2: %d\n", str1 == str2);
	printf("str3 == str2: %d\n", str3 == str2);
	printf("str4 == str5: %d\n", str4 == str5);
	printf("str4 == str6: %d\n", str4 == str6);
